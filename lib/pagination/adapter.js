...
const pageLink = (adapterParams, pageParam) => {
...
const contentPagination = adapterParams => ({
  ...
  previous_page_link: pageLink(adapterParams, previousPage(adapterParams)),
  next_page_link: pageLink(adapterParams, nextPage(adapterParams))
});
